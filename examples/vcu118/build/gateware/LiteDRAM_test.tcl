create_project -force -name LiteDRAM_test -part xcvu9p-flga2104-2-e
set_msg_config -id {Common 17-55} -new_severity {Warning}
add_files {VexRiscv.v}
add_files {LiteDRAM_test.v}
add_files {litedram_core.v}
add_files {ComputeDRAM_FSM.v}
read_xdc LiteDRAM_test.xdc
synth_design -directive default -top LiteDRAM_test -part xcvu9p-flga2104-2-e
