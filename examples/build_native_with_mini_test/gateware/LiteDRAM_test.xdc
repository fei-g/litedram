...
set_property IOSTANDARD LVDS [get_ports clk200_n]
 ## cpu_reset_n:0
set_property LOC R19 [get_ports cpu_reset_n]
...
set_property LOC V26 [get_ports led[5]]
set_property IOSTANDARD LVCMOS33 [get_ports led[5]]
set_property LOC W24 [get_ports led[6]]
set_property IOSTANDARD LVCMOS33 [get_ports led[6]]
set_property LOC W23 [get_ports led[7]]
set_property IOSTANDARD LVCMOS33 [get_ports led[7]]


 ## read btnu
set_property LOC B19 [get_ports start_read]
set_property IOSTANDARD LVCMOS33 [get_ports start_read]
 ## write btnd
set_property LOC M19 [get_ports start_write]
set_property IOSTANDARD LVCMOS33 [get_ports start_write]
 ## home btnc
set_property LOC E18 [get_ports home]
set_property IOSTANDARD LVCMOS33 [get_ports home]
 ## next btnr
set_property LOC C19 [get_ports next]
set_property IOSTANDARD LVCMOS33 [get_ports next]
 ## prev btnl
set_property LOC M20 [get_ports prev]
